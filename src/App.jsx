...
// Prefix helper so assets in /public work locally AND on GitHub Pages
const withBase = (p) => import.meta.env.BASE_URL + p;
// Fallback thumbnail (add this file to public/placeholders/)
const FALLBACK_THUMB = withBase("placeholders/card-fallback.png");
...
// Hero image stored under public/people/ (case-sensitive path!)
const jason = withBase("people/Jason-Valentine-Young.png");
...
export default function VanderbiltOpticsLabLanding() {
  ...
  return (
    <div
      ...
      style={{
        background: `radial-gradient(1200px 500px at 70% -10%, ${colors.flatGold}22, transparent), linear-gradient(180deg, #0B0B0B 0%, #0E0E0E 50%, #060606 100%)`,
      }}
    >
      {/* Header / Nav */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          <a href="#" className="flex items-center gap-3 group">
            <div
              ...
              style={{
                background: `conic-gradient(from 180deg at 50% 50%, ${colors.gold}, ${colors.flatGold}, ${colors.gold})`,
              }}
            />
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm">
            {nav.map((n) => (
              <a key={n.label} href={n.href} className="text-zinc-300 hover:text-white transition-colors">
                {n.label}
              </a>
            ))}
            <a
          ...
          <div className="lg:col-span-5">
            <div className="relative aspect-[4/3] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-xs text-zinc-200">
                ...
                <span
                  className="px-2 py-1 rounded-md bg-black/40"
                  style={{ border: `1px solid ${colors.flatGold}55` }}
                >
                  Meta-optics
                </span>
              </div>
      ...
      <section id="research" className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-zinc-400 max-w-2xl">
            From flat optics to learned reconstruction, our work spans design, computation and fabrication.
          </p>
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {research.map((r) => (
              ...
              >
                ...
                <div className="mt-4 text-sm text-zinc-300 opacity-0 group-hover:opacity-100 transition-opacity">
                  Learn more →
                </div>
              </div>
            ))}
      ...
      {/* Highlights (manual thumbnails + onError fallback) */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6">
            ...
            <div className="mt-6 grid md:grid-cols-3 gap-4">
              {highlights.map((h, i) => {
                const imgSrc = h.img ? withBase(h.img) : FALLBACK_THUMB;
                return (
                  <a
                    key={`${h.title}-${i}`}
                    href={h.href}
                    ...
                    className="rounded-2xl border border-white/10 overflow-hidden hover:bg-white/[0.06] transition-colors"
                  >
      ...
      <section id="publications" className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {p.tags.map((t) => (
                        <span
                          key={t}
                          className="text-[11px] px-2 py-1 rounded-md bg-white/5 border border-white/10 text-zinc-300"
                        >
                          {t}
                        </span>
                      ))}
          ...
          <div className="mt-6">
            <a
              href="#"
              className="inline-flex items-center gap-2 rounded-xl px-4 py-2 font-medium bg-white/5 hover:bg-white/10"
            >
          ...
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {people.map((m) => (
              <a
                key={m.name}
                href={m.url}
                className="rounded-2xl overflow-hidden border border-white/10 bg-white/[0.03] hover:bg-white/[0.06] transition-colors"
              >
            ...
            <div className="grid md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                ...
                <p className="mt-3 text-zinc-300 max-w-2xl">
                  We are actively seeking motivated students to tackle challenges at the frontier of nanoscale optics and photonics. If this looks like your place, apply to Vanderbilt and contact Prof. Valentine.
                </p>
                <div className="mt-5 flex gap-3">
                  <a
                    href="https://apply.vanderbilt.edu"
                    className="rounded-xl px-5 py-3 font-medium"
                    style={{ backgroundColor: colors.flatGold, color: colors.black }}
                  >
                    Apply
                  </a>
                  <a href="#contact" className="rounded-xl px-5 py-3 font-medium border border-white/15">
                    Contact PI
                  </a>
                </div>
              </div>
              <div className="md:col-span-1">
                <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-sm">
                  ...
                  <p className="mt-2 text-zinc-400">
                    A fast-growing tech & culture hub with vibrant food and music scenes—plus a collaborative photonics community.
                  </p>
                </div>
              </div>
            </div>
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                <div className="mt-2 text-sm text-zinc-400">
                  One-line summary of the update with a link to the full post.
                </div>
              </a>
            ))}
          </div>
            ...
            <div>
              ...
              <div className="mt-3 flex items-center gap-2 text-sm text-zinc-300">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  Olin Hall on Google Maps
                </a>
              </div>
              <div className="mt-3 text-sm text-zinc-400">
                VINSE • Mechanical Engineering • Interdisciplinary Materials Science
              </div>
            </div>
            <div>
